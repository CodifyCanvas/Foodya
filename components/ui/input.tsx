...
function Input({
  ...
  const baseStyles = cn(
    ...
    "file:inline-flex font-rubik-400 file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium"
  )

  const variants = {
  default: cn(
    "dark:bg-input/30 border-input flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none md:text-sm",
